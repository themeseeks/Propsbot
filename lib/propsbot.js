...
PropsBot.prototype._sendMessage = function (self, fromUser, originalMessage, toUser, extractedMessage) {
    ...
    self.postMessageToChannel(channel.name, "Thanks for being a great Workmate, " + fromUser.real_name + " :smile:, you gave the following feedback to " + toUser + "\n>" + extractedMessage, {as_user: true});
...
PropsBot.prototype._replyWithThankYou = function (originalMessage, toUserID, extractedMessage) {
    ...
    self._getToUserById(self, originalMessage.user, originalMessage, toUserID, extractedMessage);
}
