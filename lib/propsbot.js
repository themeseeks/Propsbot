...
PropsBot.prototype._sendMessage = function (self, fromUser, originalMessage, toUser, extractedMessage) {
    ...
    console.log(toUser + " " + extractedMessage);
    var channel = self._getChannelById(originalMessage.channel);
    self.postMessageToChannel(channel.name, "Thanks for being a great Workmate, " + toUser.real_name + " :smile:, you gave the following feedback to " + toUser + "\n>" + extractedMessage, {as_user: true});
